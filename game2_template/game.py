...
def list_of_items(items):
    ...
    l_string = ""
    for keys in items:
        l_list.append(keys["name"])
    for keys in l_list: 
        l_string = l_string + str(keys) + ", "
...
def print_menu(exits, room_items, inv_items):
    ...
    for keys in room_items:

        print("TAKE " + keys["id"].upper() + " to take " + keys["name"] + ".")

    for keys in inv_items:

        print("DROP " + keys["id"].upper() + " to drop your " + keys["name"] + ".")

    print("You are carrying: " + str(round(mass,2))+"kg.")
